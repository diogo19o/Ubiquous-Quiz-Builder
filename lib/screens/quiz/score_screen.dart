        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        Icon(MdiIcons.check, color: Colors.lightGreenAccent, size: 30,),
                        Text(
            ...
            RaisedGradientButton(
                child: Text(
                  'Início',
                  style: TextStyle(color: AppColors.PrimaryDarkBlue, fontSize: 25),
                ),
                width: size.width * .5,
                gradient: LinearGradient(
                  colors: <Color>[AppColors.PrimaryMidBlue, AppColors.SecondaryMid,AppColors.SecondaryMid, AppColors.PrimaryMidBlue,],
                ),
                onPressed: (){
                  Get.off(HomeScreen());
                }
    ...
    return Container(
      ...
      child: FlatButton(
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(MdiIcons.home, color: AppColors.PrimaryDarkBlue,),
            SizedBox(width: 10,),
            child,
          ],
        ),
